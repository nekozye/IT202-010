...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo get_url('home.php'); ?>">Game Arcade</a>
        ...
        <div class="collapse navbar-collapse" id="navContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if (!is_logged_in()) : ?>
                    ...
                    <li class="nav-item"><a class="nav-link <?php echo return_active_class_text('register.php'); ?>" href="<?php echo get_url('register.php'); ?>">Register</a></li>
                <?php endif; ?>
