        ...
        <div class="bg-light rounded form-floating">
            <div class="container-fluid">
                ...
                <form method="POST">
                    ...
                    <?php endif; ?>
                    <table class="table text-dark equidist-table">
                        <thead>
                            <th>Select</th>
                            <th>Users</th>
                            <th>Assigned role</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php foreach ($active_roles as $role) : ?>
                                    <div>
                                        <td>
                                            <input class="single-game" id="role_<?php se($role, 'id'); ?>" type="checkbox" name="roles[]" value="<?php se($role, 'id'); ?>" />
                                            
                                            <label class="single-game" for="role_<?php se($role, 'id'); ?>"><?php se($role, "name"); ?></label>
                                        </td>
                                    </div>
                                <?php endforeach; ?>
