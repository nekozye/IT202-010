...
<tr><td> <em>Response:</em> <p>There are lot of assuming in this, since I was not sure odds<br>output was &quot;odd value&quot; output or &quot;odd index&quot; output. I assumed the former.</p><br><p>Using<br>for loop, I could check if modulo 2 was not 0 for the<br>value inside the array. This means that the output is not even, therefore<br>odd.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>Rounding them was easy.</p><br><p>the more complicated problem was number must end in 2<br>decimal points. i rounded the number to 2 points decimal, and then used<br>number_format function to make sure to display them in 2 decimal points.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>The problem was last one. I assumed since they are strings, no change<br>is needed and was needed to output as is. even if the string<br>was just happened to be - numbers.</p><br><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://jc865-prod.herokuapp.com/M2/problem1.php">https://jc865-prod.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://jc865-prod.herokuapp.com/M2/problem2.php">https://jc865-prod.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://jc865-prod.herokuapp.com/M2/problem3.php">https://jc865-prod.herokuapp.com/M2/problem3.php</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Pull Request URL for M2-PHP-HW to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/nekozye/IT202-010/pull/4">https://github.com/nekozye/IT202-010/pull/4</a> </td></tr>
<tr><td> <em>Sub-Task 5: </em> Talk about what you learned, any issues you had, how you resolve them</td></tr>
<tr><td> <em>Response:</em> <p>The problem I had was not how to find what to do but<br>rather understanding the tasks. They were vague as a natural language should be,<br>but it meant a lot of assuming was necessary.<br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-010-S22/m2-php-hw/grade/jc865" target="_blank">Grading</a></td></tr></table>
